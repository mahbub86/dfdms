...
const DataTypeAddEditModal = (props) => { 
  // console.log('props modal: ', props);
  const serverpage = "datatype";// this is .php server page
  ...
  const validateForm = () => {
    ...
    let validateFields = ["DataTypeName"]
    let errorData = {}
    let isValid = true
        ...
        <div class="modal-content">
          ...
          <div class="modalItem">
            ...
            <input
              ...
              id="DataTypeName"
              name="DataTypeName"
              class={errorObject.DataTypeName}
              placeholder="Enter data type Name"
              value={currentRow.DataTypeName}
...
export default DataTypeAddEditModal;
